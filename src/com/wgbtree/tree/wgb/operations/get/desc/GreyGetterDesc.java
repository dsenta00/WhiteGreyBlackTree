...
public final class GreyGetterDesc {
	...
	Entry<K, Set<T>> getMin(Grey<K, T> grey) {
		...
		if (left != null) {
			if (left instanceof White<K, T> leftAsWhite) {
				return WhiteGetterDesc.getMin(leftAsWhite);
	...
	Entry<K, Set<T>> getMax(Grey<K, T> grey) {
		...
		if (right != null) {
			if (right instanceof Black<K, T> rightAsBlack) {
				return BlackGetterDesc.getMax(rightAsBlack);
	...
	public static <T, K extends Comparable<K>> void getAllAsc(List<Set<T>> list, Grey<K, T> grey) {
		...
		if (left != null) {
			if (left instanceof White<K, T> leftAsWhite) {
				WhiteGetterDesc.getAllAsc(list, leftAsWhite);
			} else if (left instanceof Grey<K, T> leftAsGrey) {
		...
		if (right != null) {
			if (right instanceof Black<K, T> rightAsBlack) {
				BlackGetterDesc.getAllAsc(list, rightAsBlack);
			} else if (right instanceof Grey<K, T> rightAsGrey) {
	...
	public static <T, K extends Comparable<K>> void getAllAsc(MinHeapTree<K, T> heapTree, Grey<K, T> grey) {
		...
		if (left != null) {
			if (left instanceof White<K, T> leftAsWhite) {
				WhiteGetterDesc.getAllAsc(heapTree, leftAsWhite);
			} else if (left instanceof Grey<K, T> leftAsGrey) {
		...
		if (right != null) {
			if (right instanceof Black<K, T> rightAsBlack) {
				BlackGetterDesc.getAllAsc(heapTree, rightAsBlack);
			} else if (right instanceof Grey<K, T> rightAsGrey) {
	...
	public static <T, K extends Comparable<K>> void getAllDesc(List<Set<T>> list, Grey<K, T> grey) {
		...
		if (right != null) {
			if (right instanceof Black<K, T> rightAsBlack) {
				BlackGetterDesc.getAllDesc(list, rightAsBlack);
			} else if (right instanceof Grey<K, T> rightAsGrey) {
		...
		if (left != null) {
			if (left instanceof White<K, T> leftAsWhite) {
				WhiteGetterDesc.getAllDesc(list, leftAsWhite);
			} else if (left instanceof Grey<K, T> leftAsGrey) {
	...
	public static <K extends Comparable<K>, T> void getAllDesc(MaxHeapTree<K, T> heapTree, Grey<K, T> grey) {
		...
		if (right != null) {
			if (right instanceof Black<K, T> rightAsBlack) {
				BlackGetterDesc.getAllDesc(heapTree, rightAsBlack);
			} else if (right instanceof Grey<K, T> rightAsGrey) {
		...
		if (left != null) {
			if (left instanceof White<K, T> leftAsWhite) {
				WhiteGetterDesc.getAllDesc(heapTree, leftAsWhite);
			} else if (left instanceof Grey<K, T> leftAsGrey) {

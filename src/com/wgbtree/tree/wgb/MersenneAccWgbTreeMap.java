...
public class MersenneAccWgbTreeMap <K extends Comparable<K>, T> extends WGBTreeMap<K, T> implements Serializable, AsTree<K, T> {

	public MersenneAccWgbTreeMap() {
	...
	public MersenneAccWgbTreeMap(int order) {
		super(TreeConfigCreator.createMersenne(
				assertOrder(order),
				FIRST_MERSENNE_EXP,
				DEFAULT_ARE_DUPLICATES_ALLOWED,
	...
	public MersenneAccWgbTreeMap(int order, int power) {
		super(TreeConfigCreator.createMersenne(
				assertOrder(order),
	...
	public MersenneAccWgbTreeMap(int order, int power, boolean balanced) {
		super(TreeConfigCreator.createMersenne(
				assertOrder(order),
				assertMersenneExp(power),
				DEFAULT_ARE_DUPLICATES_ALLOWED,
	...
	public MersenneAccWgbTreeMap(int order, int power, boolean balanced, boolean duplicatesAllowed) {
		super(TreeConfigCreator.createMersenne(
				assertOrder(order),
				assertMersenneExp(power),
				duplicatesAllowed,
	...
	public WGBTreeMap<K, T> cloneEmpty() {
		return new MersenneAccWgbTreeMap<>(config.getOrder(), config.getPower(), config.getBalanced(), config.getDuplicatesAllowed());
	}
